...
export default class PlatformPrefab extends Phaser.Physics.Arcade.Image {
  constructor(scene, x, y, texture, frame) {
    ...
    // Initial values for moving platforms
  ...
  update() {
    // Ensure moving platforms reverse velocity once it hits border
  ...
  startPlatformMovement() {
    this.body.velocity.x = this.horizontalVelocity; //speed & range of moving platforms
